...
def build_live_gate_report(
    *,
    ...
    lines = [
        ...
        f"- shadow_unavailable_feed_session_count: {shadow.shadow_unavailable_feed_session_count}",
        f"- skip_evidence_count: {shadow.skip_evidence_count}",
        f"- missing_skip_evidence_count: {shadow.missing_skip_evidence_count}",
